;-------------------------------------------------------------------------------
; lcd_entry_mode - set the entry mode for a Liquid Crystal Display with 
...
;-------------------------------------------------------------------------------
; Set the entry mode for an I2C Liquid Crystal display
; Registers Used:
...
;-------------------------------------------------------------------------------
            ...
            call    lcd_send_cmd    ; send entry mode control byte as command
...
;-------------------------------------------------------------------------------
; Entry Mode Control byte for an I2C Liquid Crystal display
;-------------------------------------------------------------------------------
            
            proc    entry_ctrl            
            db LCD_ENTRY            ; default entry mode is Latin-1
            endp
