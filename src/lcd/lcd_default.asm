;-------------------------------------------------------------------------------
; lcd_default - set the display values back to the default values
; on a Liquid Crystal Display with I2C using the PIO and I2C Expansion
...
;-------------------------------------------------------------------------------
; Set display back to the default values for an I2C Liquid Crystal display
; Registers Used:
...
;-------------------------------------------------------------------------------
            ...
            load    rf, disp_ctrl   ; set the display control byte
            ldi     LCD_DISPLAY     ; back to its default value 
            str     rf              ; save default display control byte
