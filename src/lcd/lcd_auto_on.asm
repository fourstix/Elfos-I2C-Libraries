;-------------------------------------------------------------------------------
; lcd_auto_on - turn autoscroll on for a Liquid Crystal Display with 
...
;-------------------------------------------------------------------------------
; Turn autoscroll on for an I2C Liquid Crystal display
; Registers Used:
...
;-------------------------------------------------------------------------------
            ...
            ldn     rf  
            ori     LCD_AUTO        ; set the autoscroll bit
