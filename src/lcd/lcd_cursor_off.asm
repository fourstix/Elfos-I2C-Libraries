;-------------------------------------------------------------------------------
; lcd_cursor_off - turn cursor off for a Liquid Crystal Display with 
...
;-------------------------------------------------------------------------------
; Turn cursor off for an I2C Liquid Crystal display
; Registers Used:
...
;-------------------------------------------------------------------------------
            ...
            ldn     rf  
            ani     LCD_NOCURSOR    ; clear the cursor bit
