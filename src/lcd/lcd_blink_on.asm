;-------------------------------------------------------------------------------
; lcd_backlight_on - turn backlignt on for Liquid Crystal Display with I2C
...
;-------------------------------------------------------------------------------
; Turn backlight on for an I2C Liquid Crystal display
; Registers Used:
...
;-------------------------------------------------------------------------------
            ...
            ldn     rf  
            ori     LCD_BLINK       ; set the blink bit
