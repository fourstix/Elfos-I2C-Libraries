;-------------------------------------------------------------------------------
; lcd_scroll_right - scroll the display right on a Liquid Crystal Display 
...
;-------------------------------------------------------------------------------
; Scroll the entire display right on a Liquid Crystal display
; Returns: 
;   DF = 0 on success, DF = 1 on error
;-------------------------------------------------------------------------------
            proc    lcd_scroll_right

            ldi     LCD_SCROLL_R        ; scroll display right
