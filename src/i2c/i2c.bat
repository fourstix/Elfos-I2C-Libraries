...
type i2c_write_byte.prg i2c_read_byte.prg i2c_wrbuf.prg i2c_rdbuf.prg i2c_rdreg.prg > i2c.lib
type i2c_clear.prg i2c_avail.prg i2c_scan.prg i2c_init.prg >> i2c.lib
