...
;-------------------------------------------------------------------------------
            ...
            proc    alnum_write_colon

            push    rd                ; save register
            
            load    rd, alnum_display_buf + AL_COLON_OFFSET
            ldn     rd                ; get colon byte from display buffer
            ori     01h               ; set colon bit on
