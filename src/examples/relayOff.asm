;-------------------------------------------------------------------------------
; relayOff - a demo program to turn off a Sparkfun Qwiic  
...
main:       lda     ra                  ; move past any spaces
            ...
            call    relay_set_off       ; turn relay off
            lbdf    errmsg              ; show msg, if unable to turn off
