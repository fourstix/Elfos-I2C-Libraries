;-------------------------------------------------------------------------------
; led7clear - a demo program to blank out an Adafruit 4 digit 7-segment 
; display with I2C using the PIO Expansion Board for the 
...
show_it:    call    i2c_init            ; initialize i2c bus
            ...
            call    led7_init           ; initialize device
            ...
            ;---- update display
            call    led7_write_disp     ; update display
            lbdf    errmsg              ; if error writing to device, exit with msg
