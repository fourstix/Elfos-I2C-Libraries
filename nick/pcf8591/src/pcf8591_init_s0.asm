;-------------------------------------------------------------------------------
; pcf8591_init_s0 - a function to configure the pcf8591 device as 4 discrete
; alalog inputs and outputs, with Channel 0 being active and DAC value from
...
; with analog output from Channel 0. Pcf8591 device address and DAC value are
; defined in the pcf8591_def.inc file above.
;
; Example:
;           call    pcf8591_init_s0    ; initialize device to:
;                                      ; Channel 0 active, 4 discrete inputs, 
...
;-------------------------------------------------------------------------------
            ...
            proc    pcf8591_init_s0    ; a0 --> channel 0
...
pcf8591s0:  db    $00+AD_CHNL_0+AD_INP_4SINGLE+AOUT_ENABLE  ; Control Byte:
