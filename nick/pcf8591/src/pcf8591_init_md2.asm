;-------------------------------------------------------------------------------
; pcf8591_init_md2 - a function to configure the pcf8591 device as discrete
; alalog inputs A0, A1 and 1 differential using A2 and A3 inputs. Three outputs 
; Chnl 0, Chnl 1 and  Chnl 2,  with Channel 2 being active and DAC value from
...
; with Channel 2 being active. Pcf8591 device address and DAC value are
; defined in the pcf8591_def.inc file above.
;
; Example:
;           call    pcf8591_init_md2   ; initialize device to:
;                                      ; Channel 2 active, 2 Discrete, 
...
;-------------------------------------------------------------------------------
            ...
            proc    pcf8591_init_md2   ; Mixed Differential: A2 + A3 --> Chnl 2
...
pcf8591md2: db    $00+AD_CHNL_2+AD_INP_2S_1DIFF+AOUT_ENABLE  ; Control Byte:
