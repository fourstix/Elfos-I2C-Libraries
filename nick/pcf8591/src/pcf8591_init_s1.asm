;-------------------------------------------------------------------------------
; pcf8591_init_s1 - a function to configure the pcf8591 device as 4 discrete
; alalog inputs and outputs, with Channel 1 being active and DAC value from
...
; with analog output from Channel 1. Pcf8591 device address and DAC value are
; defined in the pcf8591_def.inc file above.
;
; Example:
;           call    pcf8591_init_s1    ; initialize device to:
;                                      ; Channel 1 active, 4 discrete inputs, 
...
;-------------------------------------------------------------------------------
            ...
            proc    pcf8591_init_s1    ; a1 --> channel 1
...
pcf8591s1:  db    $00+AD_CHNL_1+AD_INP_4SINGLE+AOUT_ENABLE  ; Control Byte:
