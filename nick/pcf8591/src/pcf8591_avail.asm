;-------------------------------------------------------------------------------
; pcf8591_avail - a function to check the i2c bus for the presence of a 
; pcf8591 8 Bit A/D D/A with I2C using the PIO and I2C Expansion Boards for 
...
; address is defined in the pcf8591_def.inc file above
;
; Returns: 
...
;-------------------------------------------------------------------------------
            ...
            call    i2c_avail
            db      I2C_ADDR           ; see if pcf8591 a/d d/a is online
