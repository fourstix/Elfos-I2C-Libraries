;-------------------------------------------------------------------------------
; pcf8591_init_d0 - a function to configure the pcf8591 device as 2 differential
; analog DACs A0 + A1 and A2 + A3 input. Two outputs Chnl 0, Chnl 1, 
; with Channel 0 being active and DAC value from pcf8591_def.inc include
...
; A2 + A3. Two outputs Chnl 0 and Chnl 1, with Channel 0 being active.
; Pcf8591 device address and DAC value are defined in the pcf8591_def.inc file above.
;
; Example:
;           call    pcf8591_init_d0   ; initialize device to:
;                                      ; Channel 0 active, 2 differential inputs, 
...
;-------------------------------------------------------------------------------
            ...
            proc    pcf8591_init_d0:   ; Differential: A0 + A1 --> Chnl 0
...
pcf8591d0:  db    $00+AD_CHNL_0+AD_INP_2DIFF+AOUT_ENABLE  ; Control Byte:
