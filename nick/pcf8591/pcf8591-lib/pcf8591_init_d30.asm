;-------------------------------------------------------------------------------
; pcf8591_init_d30 - a function to configure the pcf8591 device as 3 differential
; alalog inputs A0, A1, A2 with a common A3 input. Three outputs Chnl 0, Chnl 1, 
; and Chnl 2,  with Channel 0 being active and DAC value from
...
; Channel 0 being active. Pcf8591 device address and DAC value are
; defined in the pcf8591_def.inc file above.
;
; Example:
;           call    pcf8591_init_d30   ; initialize device to:
;                                      ; Channel 0 active, 3 differential inputs, 
...
;-------------------------------------------------------------------------------
            ...
            proc    pcf8591_init_d30   ; Differential inputs - A0 + A3 --> Chnl 0
...
pcf8591d30: db    $00+AD_CHNL_0+AD_INP_3DIFF+AOUT_ENABLE  ; Control Byte:
