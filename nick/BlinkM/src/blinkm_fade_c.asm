;-------------------------------------------------------------------------------
; blinkm_fade_c - a function to have the BlinkM Smart Led fade to a specific 
...
;-------------------------------------------------------------------------------
; This routine has the BlinkM Smart Led fade to a specific RGB (Red, Green, Blue)
; color. The BlinkM device's address is defined in the blinkm_def.inc file above
;    
; Example: 
;   The following instructs the BlinkM Smart led to fade to the passed RGB color
;           call    call    blinkm_fade_c   ; write to blinkm device go to color
;           db      C_WHITE                 ; three bytes that define WHITE R, G, B
;
; Returns: 
...
;-------------------------------------------------------------------------------
            ...
            mov     r8, blinkmf+1      ; point to where the RGB values go in the i2c cmd
...
blinkmf:    db    'c',$00,$00,$00      ; fade to R, G , B
