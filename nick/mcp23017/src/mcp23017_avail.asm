;-------------------------------------------------------------------------------
; mcp23017_avail - a function to check the i2c bus for the presence of a 
; GPIO chip with I2C using the PIO and I2C Expansion Boards for 
...
; address is defined in the mcp23017_def.inc file above
;
; Returns: 
...
;-------------------------------------------------------------------------------
            ...
            call    i2c_avail          ; i2c address = {$20,$21,$22,$23,$24,$25,$26,$27}
            db      I2C_ADDR
